...
<body <?php if ($ins === 1) {echo "class='admin'";} ?>>
    ...
    <div id="feed">
        <div class="post post-type-status">
            ...
            <div class="post-meta">
                <input type="checkbox" id="del_<?=$data["timestamp"]?>" data-cancel="<?=$loc_loop_deleteCancel?>"><label for="del_<?=$data["timestamp"]?>" data-cancel="<?=$loc_loop_deleteCancel?>"><?=$loc_loop_delete?></label><a class="operations operations-delete" href="../../core/delete.php?id=<?=$data["timestamp"]?>&type=status"><?=$loc_loop_deleteConfirm?></a>
                <a class="operations operations-edit" href="../../core/add/status.php?edit=<?=$data["timestamp"]?>"><?=$loc_loop_edit?></a>

...
<body <?php if ($ins === 1) {echo "class='admin'";} ?>>
    ...
    <?php } ?>
        ...
        <?php
            ...
            if (file_exists("https://rajnoha.com/core/indexes/global")) {

            // parse all posts (because it's the initial view mode)
            $totalPosts = array_reverse(array_filter(explode("|",file_get_contents("https://rajnoha.com/core/indexes/global"))));
            ...
            $limitCounter = 0;
            $files = glob("https://rajnoha.com/core/indexes/" . "*");
            if ($files){
            ...
            if (isset($_POST["type"]) && $_POST["type"] !== "") {
                $totalPosts = array_reverse(array_filter(explode("|",file_get_contents("https://rajnoha.com/core/indexes/".$_POST["type"]))));
                $totalPostCount = count($totalPosts);
            }
            ...
            foreach ($totalPosts as $single) {
                $singleArray = json_decode(file_get_contents("https://rajnoha.com/p/".$single."/meta.json"), true);
                if ($lookUp == 1) {
            ...
            for ($loopStart = $loopStart;$loopStart < $loopLimit; $loopStart++) {
                ...
                if ($single["type"] === "status") {
                    ...
                    echo '<div class="post post-type-image"><div class="post-content"><img src="https://rajnoha.com/p/'.$single["timestamp"].'/600_1.jpg" alt="">';
                    ...
                    echo '<div class="post post-type-video"><div class="post-content"><video controls><source src="https://rajnoha.com/p/'.$single["timestamp"].'/full.mp4" type="video/mp4"></video>';
                    if ($single["location"] && $single["location"] !== "") {
                        echo "<a class='location' href='https://mapy.cz?q=".$single["location"]."'>".$single["location"]."</a>";
                    }
                    ...
                    for($i=0;$i<$single['count'];$i++){
                        ...
                        if ($i === 0) {
                            ...
                            echo '<img src="https://rajnoha.com/p/'.$single["timestamp"].'/600_'.($i+1).'.jpg" alt="">';
